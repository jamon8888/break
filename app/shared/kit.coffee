...
if typeof window is 'undefined'
  ...
  exports.kit.couch = require('backbone-couch')({
    host: '127.0.0.1'
    port: '5984'
    name: 'telerama_backup'
  })
  BaseModel = Backbone.Model
  #BaseModel = require('Backbone-relational')
  ...
  uuid = @uuid
  Backbone = @Backbone
  BaseModel = Backbone.RelationalModel
  #Backbone.RelationalModel = @Backbone.RelationalModel
  exports.kit = {}

#console.log(exports.kit.couch)
exports.kit.stash = {}
...
#_.extend(Model::, BaseModel.prototype)
#@Model = Model
...
class exports.kit.model extends Model
  schema: {}
  ...
  initialize : ->
    ...
    if server and not @get("id")
      @set(id: @attributes['_id']?.split('/').pop())
      @set isNew: true
      #@set id:
...
#class exports.kit.relationalModel extends BaseModel
class exports.kit.relationalModel
  constructor: ->
    BaseModel.apply(this, arguments)

_.extend(exports.kit.relationalModel::, BaseModel.prototype, exports.kit.model)
#@Model = Model

#_.extend(exports.kit.relationalModel, exports.kit.model)
#console.log(exports.kit.relationalModel)
#console.log(new exports.kit.relationalModel)
